package com.example.prestamos.views
...
import com.example.prestamos.components.Alert
import com.example.prestamos.components.MainButton
import com.example.prestamos.components.MainTextFields
import com.example.prestamos.components.ShowInforCards
import com.example.prestamos.components.SpaceH
...
fun ContentHomeView(paddingValues: PaddingValues){
    ...
    Column(modifier = Modifier
        ...
        MainTextFields(value = montoPrestamo, onValueChange = { montoPrestamo = it}, label = "Prestamo")
        SpaceH()
        MainTextFields(value = cantCuotas, onValueChange = {cantCuotas= it}, label = "Cuotas")
        SpaceH(10.dp)
        MainTextFields(value = tasa, onValueChange = {tasa = it}, label = "Tasa")
        SpaceH(20.dp)
